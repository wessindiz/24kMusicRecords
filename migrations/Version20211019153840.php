 ...
 */
final class Version20211019153840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar ADD id_categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calendar DROP id_categorie_id');
    }
}
